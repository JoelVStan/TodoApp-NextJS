...
export default function Home() {
  ...
  return (
    <>
      ...
      <form onSubmit={onSubmitHandler} className="flex items-center flex-col gap-2 w-[80%] max-w-[600px] mt-24 px-2 mx-auto">
        ...
        <button type="submit" className="bg-blue-600 py-3 px-11 text-white rounded font-bold w-[250px]">Add Todo</button>
      </form>
